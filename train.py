...
def get_parser():
    ...
    parser.add_argument('--num_pred', type=int, default=6, help='This is the number of predictions for each agent')
    ...
    parser.add_argument(
        ...
        help='Set this value to 0~4 for ETH-univ, ETH-hotel, UCY-zara01, UCY-zara02, UCY-univ')  #PG: for citysim, 0 means IntersectiomB-01_gatraj.csv, 1 means IntersectionB-02_gatraj.csv
    parser.add_argument(
        '--base_dir',default='.',
    ...
    ######################################
    parser.add_argument(
        '--dataset',default='citysim')  #PG: changed to citysim from eth5
